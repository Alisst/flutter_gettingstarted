...
import 'package:flutter_gettingstarted/shared/menu_bottom.dart';
...
class _BmiScreenState extends State<BmiScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: MenuDrawer(),
      //SingleChildScrollView this widget is for not getting error after changing orientation of device
